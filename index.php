...
<body class="login-page" style="background:linear-gradient(to top,#66ccff,#ccffff,#ff6666);">
	<div class="login-wrap d-flex align-items-center flex-wrap justify-content-center">
		<div class="container">
			<div class="row align-items-center">
				<div class="col-md-6 col-lg-7">
					<img src="vendors\images\ace5.jpeg" width="1366px" height="768" alt="">
				</div>
				<div class="col-md-6 col-lg-5">
					<div class="login-box bg-white box-shadow border-radius-10">
						<div class="login-title">
							<h2 class="text-center text-primary">Welcome To ACE Leave Portal</h2>
						</div>
							...
							<div class="row">
								<div class="col-sm-12">
									<div class="input-group mb-0">
									   ...
									   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<h6 style="text-align:center; color:black;"><i><b><u><a href="akshay info.php" target="_blank">Developed by SAAPY</a></u></b></i></h6>
									</div>
								</div>
							</div>
						</form>
	...
	<h1 style="text-align:center; color:#0000ff;  background:linear-gradient(to bottom,orange,white,white,white,green);"><strong><i><a href="http://www.acenagthana.ac.in/gallery.php">Agnihotri College of Engineering Nagthana,Wardha</a></i></strong></h1>
	<!-- js -->
